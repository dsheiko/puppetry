...
const actions = createActions({
  ...
  /**
    ...
    * @returns {object}
    */
  INSERT_ADJACENT_SNIPPETS_TARGET: ( options, position, id = null ) => ({
    position,
    options,
    id
  }),
  /**
    ...
    * @returns {object}
    */
  SET_SNIPPETS_TARGET: ( options ) => validate( options, { ...I.ENTITY, ...I.TARGET, ...I.UPDATE }),
  /**
    * @param {object} options = { id, target, selector, editing }
    * @returns {object}
    */
  UPDATE_SNIPPETS_TARGET: ( options ) => validate( options, { ...I.ENTITY, ...I.TARGET, ...I.UPDATE }),
  /**
    * @param {object} ref = { id }
    * @returns {object}
    */
  REMOVE_SNIPPETS_TARGET: ( ref ) => validate( ref, I.UPDATE )
