...
const actions = createActions({
  ...
  /**
    ...
    * @returns {object}
    */
  INSERT_ADJACENT_PAGE: ( options, position, id = null ) => ({
    position,
    options,
    id
  }),
  /**
    ...
    * @returns {object}
    */
  SET_PAGE: ( options ) => validate( options, { ...I.ENTITY, ...I.PAGE, ...I.UPDATE }),
  /**
    * @param {object} options = { id, target, selector, editing }
    * @returns {object}
    */
  UPDATE_PAGE: ( options ) => validate( options, { ...I.ENTITY, ...I.PAGE, ...I.UPDATE }),
  /**
    * @param {object} ref = { id }
    * @returns {object}
    */
  REMOVE_PAGE: ( ref ) => validate( ref, I.UPDATE )
