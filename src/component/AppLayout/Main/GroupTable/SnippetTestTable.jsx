...
import { SnippetCommandTable } from "./TestTable/SnippetCommandTable";
...
const mapStateToProps = ( state ) => ({
        ...
        tests: selectors.getSnippetsTestDataTableMemoized( state )
      }),
...
@connectDnD
export class SnippetTestTable extends AbstractEditableTable {
