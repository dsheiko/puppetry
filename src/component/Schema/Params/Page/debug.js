...
await bs.page.evaluate(() => {
  ...
  description: `Stop execution of JavaScript, and calls (if available) the debugging function
[See debugger statement](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/debugger).
