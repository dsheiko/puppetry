...
export const tplSuite = ({ title, body, targets, suite, runner, projectDirectory, outputDirectory, env }) => `
/**
...
describe( ${ JSON.stringify( title ) }, async () => {
  beforeAll(async () => {
    ...
    bs.page.on( "load", async () => {
      ...
      await bs.page.addScriptTag({ content: \`${ readInteractAsset( outputDirectory, "toolbox.js" ) }\`});
